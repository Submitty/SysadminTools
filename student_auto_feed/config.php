...
//LDAP
define('LDAP_URI',       'ldap://myuniversity.edu:389');
define('LDAP_USER',      'my_login');
define('LDAP_PASSWORD',  'my_password');
// string "%COURSE%" can be inserted where a course code is part of the DN.
define('LDAP_COURSE_DN', 'CN=my_cn,OU=my_ou,DC=myuniversity,DC=edu');
